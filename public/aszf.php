...
?>
  <div class="container">
    <article class="legal">
      <h1 class="aszf-title">Általános Szerződési Feltételek</h1>
      <p class="aszf-effective">Hatályos: 2026. július 2.</p>
      <hr class="aszf-rule">

      <div class="aszf-brief" aria-label="Röviden">
        <b>Röviden:</b>
        <ul>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">1. §</span>A szolgáltató</h2>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">2. §</span>A szolgáltatás leírása</h2>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">3. §</span>A használat feltételei</h2>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">4. §</span>Felelősség</h2>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">5. §</span>Szellemi tulajdon</h2>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">6. §</span>Az ÁSZF módosítása</h2>
      ...
      <section class="aszf-sec">
        <h2><span class="aszf-par" aria-hidden="true">7. §</span>Kapcsolat</h2>
