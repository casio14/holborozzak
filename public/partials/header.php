  ...
  <header class="site-header">
    <div class="site-header__inner">
      ...
      <nav class="site-nav" aria-label="Fő navigáció">
        ...
        <a href="borvidekek"<?= $activeNav === 'borvidekek' ? ' class="is-active" aria-current="page"' : '' ?>>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            <path d="M12.5 4.5c1-1.2 2.8-1.3 3.5-.8"/>
            <circle cx="9" cy="10" r="1.9"/><circle cx="15" cy="10" r="1.9"/><circle cx="12" cy="13.4" r="1.9"/>
            <circle cx="9" cy="16.8" r="1.9"/><circle cx="15" cy="16.8" r="1.9"/>
          </svg>
          Borvidékek
        </a>
